...
class _PostComposeScreenState extends State<PostComposeScreen> {
      ...
      builder: (ctx) => SafeArea(
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          ListTile(
            ...
            subtitle: Text('최대 ${_maxImages - _selectedImages.length}장 더 추가 가능',
  ...
  Future<void> _submit() async {
    ...
    if (title.isEmpty) { _showError('제목을 입력해주세요'); return; }
    if (body.length < 5) { _showError('내용을 5자 이상 입력해주세요'); return; }
    final banned = _checkBannedKeywords('$title $body');
    if (banned != null) { await _showBannedKeywordDialog(banned); return; }
    ...
    try {
      ...
      await PostService.instance.createPost(
        title: title, body: body, category: _category,
        linkedFishName: widget.prefilledFishName,
        imageBase64Thumbs: thumbList, imageBase64Fulls: fullList,
      );
      if (!mounted) return;
      ...
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        content: Row(children: [
          ...
          SizedBox(width: 8), Text('게시글이 등록됐어요'),
        ]),
  ...
  void _showError(String message) {
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      content: Text(message), backgroundColor: _kRed,
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Row(children: [
          Container(width: 40, height: 40,
            decoration: BoxDecoration(color: _kRed.withOpacity(0.1),
        ...
        content: Column(mainAxisSize: MainAxisSize.min,
          ...
          const Text('커뮤니티 규칙에 위배되는 단어가 포함되어 있어요.',
          ...
          Container(padding: const EdgeInsets.all(12),
            ...
            child: Row(children: [
              ...
              Expanded(child: Text('감지된 단어: "$keyword"',
                style: const TextStyle(color: _kRed,
                  fontWeight: FontWeight.bold, fontSize: 13))),
            ])),
          const SizedBox(height: 12),
          const Text('나우피싱은 정치·종교·음란성 콘텐츠를 허용하지 않습니다.\n낚시 관련 내용으로 작성해주세요.',
  ...
  Future<bool?> _showFinalConfirmation() async {
    return showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text('게시 후에는 본인 외에 수정이 어렵습니다.\n내용을 한 번 더 확인해주세요.',
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          // 제목
          TextField(
            controller: _titleController, maxLength: 50,
          ...
          // 본문
          TextField(
            controller: _bodyController, maxLength: 2000,
  ...
  Widget _buildImageSection() {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Row(children: [
        ...
        const Text('사진', style: TextStyle(fontWeight: FontWeight.bold, color: _kNavy, fontSize: 14)),
        const SizedBox(width: 6),
      ...
      if (hasImages) ...[
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemCount: canAddMore ? _selectedImages.length + 1 : _selectedImages.length,
            itemBuilder: (context, index) {
              if (index == _selectedImages.length) return _buildAddMoreButton();
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: Column(children: [
              ...
              const SizedBox(height: 12),
              const Text('📷 사진 첨부하기',
                style: TextStyle(color: _kPrimary, fontWeight: FontWeight.bold, fontSize: 15)),
              const SizedBox(height: 4),
              const Text('최대 5장 • 갤러리 또는 카메라',
      ...
      child: Stack(children: [
        ClipRRect(
          ...
          child: Image.file(_selectedImages[index],
            width: 100, height: 104, fit: BoxFit.cover)),
        if (index == 0)
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          Text('${_maxImages - _selectedImages.length}장 추가',
  ...
  Widget _categoryCard(String code, String emoji, String label, Color color) {
    ...
    return Expanded(
      child: GestureDetector(
        onTap: () { HapticFeedback.selectionClick(); setState(() => _category = code); },
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(12),
            border: Border.all(
              color: isSelected ? color : _kBorder, width: isSelected ? 1.5 : 1)),
          child: Column(children: [
